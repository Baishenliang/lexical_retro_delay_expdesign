...
first_stims = readtable(fullfile('data',testing_folder,'first_stims_Block5.txt'));
td = first_stims.Var1(1);
load(fullfile('data',testing_folder,"Test1202_Block_3_TrialData.mat"));
pc_onset = trialInfo{1,116}.audio1Start;
...
f_stims = fopen(fullfile('data',testing_folder,'stims_Block5.txt'), 'w');
f_cues = fopen(fullfile('data',testing_folder,'retrocues_Block5.txt'),'w');
f_gos = fopen(fullfile('data',testing_folder,'gos_Block5.txt'),'w');
