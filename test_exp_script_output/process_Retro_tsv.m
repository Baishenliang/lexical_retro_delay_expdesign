...
first_stims = readtable(fullfile('data',testing_folder,'first_stims_Block4.txt'));
...
f_stims = fopen(fullfile('data',testing_folder,'stims_Block4.txt'), 'w');
f_cues = fopen(fullfile('data',testing_folder,'retrocues_Block4.txt'),'w');
f_gos = fopen(fullfile('data',testing_folder,'gos_Block4.txt'),'w');
