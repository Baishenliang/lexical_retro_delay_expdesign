...
data_tsv = readtable(fullfile('data',testing_folder,'Test20241208_Block_1.csv'));
data_tsv(strcmp(data_tsv{:, 3}, 'Record_onset'), :) = [];
first_stims = readtable(fullfile('data',testing_folder,'first_stims_Block1.txt'));
td = first_stims.Var1(1);
load(fullfile('data',testing_folder,"Test20241208_Block_1_TrialData.mat"));
...
f_stims = fopen(fullfile('data',testing_folder,'stims_Block1.txt'), 'w');
f_cues = fopen(fullfile('data',testing_folder,'retrocues_Block1.txt'),'w');
f_gos = fopen(fullfile('data',testing_folder,'gos_Block1.txt'),'w');
